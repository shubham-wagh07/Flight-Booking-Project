                ...
                <div class="row">
                    <div class="col-md-5 mx-auto">
                        <div class="card card-body">
                            ...
                            <form id="submitForm" action="add_flight_details" method="post" data-parsley-validate="" data-parsley-errors-messages-disabled="true" novalidate="" _lpchecked="1"><input type="hidden" name="_csrf" value="7635eb83-1f95-4b32-8788-abec2724a9a4">
                                <div class="form-group required">
                                    <lSabel for="flight_id">Flight Id</lSabel>
                                    <input type="text"  class="form-control text-lowercase" id="flight_id" name="flight_id" required>
                                </div>                    
                                <div class="form-group required">
                                ...
                                <div class="form-group required">
                                    <label class="d-flex flex-row align-items-center" for="etd">Estimated Travel Duration 
                                        <a class="ml-auto border-link small-xl" href="/forget-password"></a></label>
                                    <input type="text"  class="form-control"  id="etd" name="etd" required>
                                </div>
                                ...
                                <div class="form-group required">
                                    <label class="d-flex flex-row align-items-center" for="reservation_type">Reservation Type
                                        <a class="ml-auto border-link small-xl" href="/forget-password"></a></label>
                                    <input type="text"  class="form-control"  id="reservation_type" name="reservation_type" required>
                                </div>
                                
                                <div class="form-group required">
                                    <label class="d-flex flex-row align-items-center" for="reservation_capacitu">Reservation Capacity
                                        <a class="ml-auto border-link small-xl" href="/forget-password"></a></label>
                                    <input type="text"  class="form-control"  id="reservation_capacity" name="reservation_capacity" required>
                                </div>
