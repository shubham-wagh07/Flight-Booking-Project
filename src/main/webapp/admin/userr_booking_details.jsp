...
<title>User Booking Detals</title>
            ...
            <div class="d-flex  flex-column flex-lg-row align-items-center w-100 justify-content-between">
              <ul class="navbar-nav  ">
               ...
               <li class="nav-item active">
                ...
                <li class="nav-item active">
                  <a class="nav-link" href="flight_schedule_details.jsp">View Scheduled Flight Details </a>
                </li>
...
<div class="login_btn-contanier ml-0 ml-lg-5">
    ...
    <div class="bgdiv">
		...
		<table class="flightListTable" style="width: 100%">
			...
			PreparedStatement ps=conn.prepareStatement("select * from flight_booking_details");
